...
// Define layer names
enum layer_names { _CUSTOM_COLEMAK = 0, _TL, _TR, _TLTR };

// Define custom keycodes for Kanata-specific behaviors that don't have direct
// QMK equivalents. These will require custom process_record_user functions for
// full functionality.
enum custom_keycodes {
  ...
  KC_8F,
  KC_9F,
  KC_0F, // Function key forks
  // KC_SCRE,            // Screen control (removed, using KC_SLEP directly)
  KC_MUP,
  KC_MDN,
  KC_MLFT,
  KC_MRGT, // Mouse movement
  KC_WHUP,
  KC_WHDN,
  KC_WHLFT,
  KC_WHRGT,   // Scroll movement
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CUSTOM_COLEMAK] = LAYOUT_split_2x6_1x5_2(
        // Left hand
        KC_CAPS_WORD, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_DELF, KC_A, KC_R, KC_S,
        KC_T, KC_G, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_TL_MO,
        KC_OS_LSFT, // Left thumb cluster (2 keys)
        // Right hand
        KC_J, KC_L, KC_U, KC_Y, KC_QUOT, KC_SCLN, KC_M, KC_N, KC_E, KC_I, KC_O,
        KC_TRNS, // _ is transparent
        KC_K, KC_H, KC_COMF, KC_DOTF, KC_SLAF, KC_SPC,
        KC_TR_MO // Right thumb cluster (2 keys)
        ),

    [_TL] = LAYOUT_split_2x6_1x5_2(
        // Left hand
        KC_NO, KC_ESC, KC_OS_WIN, KC_NO, KC_NO, KC_NO, // @sFn is nop0, so KC_NO
        KC_TRNS, KC_OS_LALT, KC_OS_LCTL, KC_OS_LSFT, KC_OS_LGUI, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_OS_HYPR, KC_NO, KC_TRNS,
        KC_TRNS, // Left thumb cluster (2 keys)
        // Right hand
        KC_PGUF, KC_BTAB, KC_UP, KC_TAB, KC_NO, KC_NO, KC_PGDF, KC_LEFT,
        KC_DOWN, KC_RIGHT, KC_NO, KC_TRNS, KC_NO, KC_BSPC, KC_DEL, KC_NO,
        KC_TRNS, KC_TRNS, KC_TLTR_MO // Right thumb cluster (2 keys)
        ),

    [_TR] = LAYOUT_split_2x6_1x5_2(
        // Left hand
        KC_NO, KC_EXCF, KC_ATSF, KC_OCTF, KC_DOLF, KC_NO, KC_TRNS, KC_AMPF,
        KC_SQRF, KC_CURF, KC_PARF, KC_NO, KC_NO, KC_NO, KC_ANOO, KC_ANCC, KC_NO,
        KC_TLTR_MO, KC_TRNS, // Left thumb cluster (2 keys)
        // Right hand
        KC_PERF, KC_7F, KC_8F, KC_9F, KC_PLUS, KC_EQL, KC_ASTF, KC_4F, KC_5F,
        KC_6F, KC_6F, KC_TRNS, KC_0F, KC_1F, KC_2F, KC_3F, KC_SLAF, KC_TRNS,
        KC_TRNS // Right thumb cluster (2 keys)
        ),

    [_TLTR] = LAYOUT_split_2x6_1x5_2(
        // Left hand
        KC_NO, KC_SLEP, KC_BRIU, KC_MPLY, KC_VOLU, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_BTN1, KC_BTN2, KC_NO, KC_BRID, KC_MPRV, KC_VOLD, KC_NO, KC_NO,
        KC_TRNS, // Left thumb cluster (2 keys)
        // Right hand
        KC_NO, KC_NO, KC_MUP, KC_NO, KC_NO, KC_TRNS, // lrld is transparent
        KC_NO, KC_MLFT, KC_MDN, KC_MRGT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_TRNS, KC_NO // Right thumb cluster (2 keys)
        )};
